...
const AdminLeaveRequestsWidget = () => {
  ...
  return (
    <div className="rounded-2xl border border-gray-100 bg-white shadow-sm">
      <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
        ...
        <Link to="/admin/leave" className="text-xs font-medium text-indigo-600 hover:underline">View all</Link>
      </div>
              ...
              <li key={l._id} className="flex items-center gap-3 px-5 py-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="truncate text-xs text-gray-400">
                    {formatDate(l.fromDate)}{l.toDate ? ` → ${formatDate(l.toDate)}` : ""}
                  </p>
                </div>
...
export default AdminLeaveRequestsWidget;
